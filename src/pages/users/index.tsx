...
import { setUsers, addUser, updateUser, removeUser } from "@/store/reducer/userReducer";
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={openDelete} onClose={() => setOpenDelete(false)}>
        ...
        <DialogContent>Bạn có chắc muốn xóa user {selectedUser?.name} không?</DialogContent>
        <DialogActions>
